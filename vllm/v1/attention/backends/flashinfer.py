...
class FlashInferMetadataBuilder(AttentionMetadataBuilder[FlashInferMetadata]):
    ...
    def get_cudagraph_support(
        ...
        # Neither trtllm-gen nor the graph-safe uniform decode path supports
        # the non-causal FlashInfer prefill wrapper used by draft attention.
        if not vllm_config.attention_config.use_non_causal and (
